                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/organization/insert' />">
										<div class="form-group">
										    ...
										    <input class="form-control" type="text" name="ORGANIZATION_SEQ" value="${paramMap.ORGANIZATION_SEQ}"  readonly >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="TELEPHONE" placeholder="000) 00-0000-0000" value="${paramMap.TELEPHONE}">
                                            <p class="help-block">Base form 000) 00-0000-0000</p>
                                        </div>
                                        <div class="form-group">
										    <label for="disabledSelect">ORDER_NUMBER Disabled input </label>
										    <input class="form-control" type="text" name="ORDER_NUMBER" value="1" >
                                            <p class="help-block">disabled</p>
                                        </div>
                                        <div class="form-group">
										    <label for="disabledSelect">PARENT_ORGANIZATION_SEQ Disabled input </label>
										    <input class="form-control" type="text" name="PARENT_ORGANIZATION_SEQ" value="${paramMap.PARENT_ORGANIZATION_SEQ}" readonly>
                                            <p class="help-block">using Parent UUID method with disabled</p>
                                        </div>
                                        <input type="hidden" name="IS_NEW" value="${paramMap.IS_NEW}"></button>
