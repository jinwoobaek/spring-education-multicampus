                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/organization/delete?ORGANIZATION_SEQ=${paramMap.ORGANIZATION_SEQ}' />">
                                        ...
                                        <a href="<c:url value='/organization/edit?ORGANIZATION_SEQ=${paramMap.ORGANIZATION_SEQ}' />"><button type="button" class="btn btn-default">Update Button</button></a>
                                        <button type="submit" class="btn btn-default" style="color:#a94442;">Delete Button</button>
